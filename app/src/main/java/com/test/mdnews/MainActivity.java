...
import com.test.mdnews.gson.News;
import com.test.mdnews.gson.NewsList;
import com.test.mdnews.util.HttpUtil;
import com.test.mdnews.util.Utility;
...
public class MainActivity extends AppCompatActivity {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (code == 200){
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            adapter.notifyDataSetChanged();//https://baike.1688.com/doc/view-d35952222.html
                            listView.setSelection(0);//listview.setselection(position)，表示将列表移动到指定的Position处.https://blog.csdn.net/szyangzhen/article/details/47972509,https://zhidao.baidu.com/question/1238498530318531059.html
    ...
    private String response(int itemName) {
        String address = "https://api.tianapi.com/social/?key=b111e7cb914db406c7e2cb7aa6198d0e&num=10";
        switch (itemName){
            case ITEM_SOCIETY:
                break;
            case ITEM_COUNTY:
